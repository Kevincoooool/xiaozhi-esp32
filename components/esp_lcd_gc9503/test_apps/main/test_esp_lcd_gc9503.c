...
#define TEST_LCD_IO_SPI_SCL_1       (TEST_LCD_IO_RGB_DATA14)
#define TEST_LCD_IO_SPI_SDO_1       (TEST_LCD_IO_RGB_DATA15)
#define TEST_LCD_IO_SPI_CS_2        (IO_EXPANDER_PIN_NUM_1)
#define TEST_LCD_IO_SPI_SCL_2       (IO_EXPANDER_PIN_NUM_2)
#define TEST_LCD_IO_SPI_SDO_2       (IO_EXPANDER_PIN_NUM_3)
...
TEST_CASE("test gc9503 to draw color bar with RGB interface, using GPIO", "[gc9503][rgb][gpio]")
{
    ...
    TEST_ESP_OK(esp_lcd_new_panel_gc9503(io_handle, &panel_config, &panel_handle));
...
TEST_CASE("test gc9503 to draw color bar with RGB interface, using IO expander", "[gc9503][rgb][expander]")
{
    ...
    spi_line_config_t line_config = {
        ...
        .scl_expander_pin = TEST_LCD_IO_SPI_SCL_2,
        .sda_io_type = IO_TYPE_EXPANDER,
        .sda_expander_pin = TEST_LCD_IO_SPI_SDO_2,
...
void app_main(void)
{
    ...
    */
    printf("   ___   ___  ___  ____   ___ _____\r\n");
