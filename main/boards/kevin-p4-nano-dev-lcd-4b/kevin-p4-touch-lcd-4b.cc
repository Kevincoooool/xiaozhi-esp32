...
private:
    ...
    void InitializeLCDGC9503() {
        ...
        esp_lcd_dpi_panel_config_t dpi_config = GC9503_480_800_PANEL_60HZ_DPI_CONFIG(LCD_COLOR_PIXEL_FORMAT_RGB565);
        ...
        esp_lcd_new_panel_gc9503(io, &lcd_dev_config, &disp_panel);
        esp_lcd_panel_reset(disp_panel);
        esp_lcd_panel_init(disp_panel);
