...
LV_FONT_DECLARE(font_dingdingjbt33);
...
void lv_gui_start(void)
{
    ...
    lv_obj_set_style_text_font(label_wifi_info, &font_dingdingjbt33, LV_STATE_DEFAULT);
...
void lv_main_page(void)
{
    ...
    lv_obj_set_width(label_ask, 300);
    ...
    lv_obj_set_style_text_font(label_ask, &font_dingdingjbt33, LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(label_reply, 300);
    // lv_obj_set_height(label_reply, 200);
    // lv_label_set_long_mode(label_ask, LV_LABEL_LONG_SCROLL_CIRCULAR); /*Circular scroll*/
    lv_obj_align(label_reply, LV_ALIGN_TOP_LEFT, 10, 10);
    lv_obj_set_style_text_font(label_reply, &font_dingdingjbt33, LV_STATE_DEFAULT);
